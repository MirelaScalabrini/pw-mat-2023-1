...
/*
 O método includes() testa se um dado elemento existe no vetor. Retorna true se existir ou false caso contrário.
*/
...
/*
 O método indexOf() retorna o índice (posição) de um elemento no vetor. Caso o elemento não exista, retorna o valor -1
*/
