...
/*
 O método map() cria um Novo Vetor, de tamanho idêntico ao vetor original, em que cada elemento corresponde a uma tranformação feita no elemento original pela função passada 
 com parâmetro.
*/
