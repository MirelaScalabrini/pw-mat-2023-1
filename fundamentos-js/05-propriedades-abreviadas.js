...
Exibindo o valor de duas variáveis. Veja que os valores são exibidos, mas a saída não informa de quais variáveis provêm os valores
*/
let x = 10, y = 'batata'
console.log(x, y)
// Saída melhorada: passando um objeto com propriedades abreviadas para console.log(), como uma forma de sabermos de quais variáveis provêm os valores.
console.log({x, y})